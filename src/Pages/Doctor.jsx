      ...
      <div className="relative max-w-7xl mx-auto h-full flex flex-col items-center px-16 py-16 ">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-gray-300 mt-4">
            Book an appointment with the best specialists to take care of your
            health.
          </p>
        </div>
        <DoctorCompo
          name=" Dr. Kritika Ghimire"
          specification="General Physician | Endocrinology"
          NMC="5676778"
          qual=" MBBS, MD (Internal Medicine)"
          schedule=" Sun - Fri : 3 PM to 8 PM (Lalitpur)"
        />
        <DoctorCompo
          name=" Dr. Akriti Sapkota "
          specification="Pediatric Surgeon"
          NMC="5676678"
          qual=" MBBS, MD (Internal Medicine)"
          schedule=" Sun - Fri : 3 PM to 8 PM (Lalitpur)"
        />
...
const DoctorCompo = ({ 
  name, specification, NMC, qual, schedule 
